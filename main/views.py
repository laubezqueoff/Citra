...
from main.forms import MessageForm, ReviewForm, FormShop
...
# def editShop(request, id_shop):
#     person_id, rol, rol_id, is_active = get_context(request)
#     context = [person_id, rol, rol_id, is_active]
#     shop = get_object_or_404(Shop, pk=id_shop)
#     form = FormShop()

#     return render(request, 'shop_edit.html', {'context': context, 'form': form, 'shop': shop})
