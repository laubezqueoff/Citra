...
urlpatterns = [
    ...
    path('product/<id_product>/delete',
         views.product_delete, name="product_delete"),
    path('product/<id_product>/promotionweekproduct',
         views.promotion_week_product, name="promotion_week_product"),
    path('product/<id_product>/promotionmonthproduct',
         views.promotion_month_product, name="promotion_month_product"),
    ...
    path('shops/<id_shop>/activateshop',
     ...
     path('shops/<id_shop>/activateshopthreemonths',
         views.activate_shop_three_months, name="activate_shop_three_months"),
     path('shops/<id_shop>/activateshoponeyear',
         views.activate_shop_one_year, name="activate_shop_one_year"),
    path('shops/', views.list_shop, name="shops"),
    path('shop/bookings/acceptbookings/', views.accept_booking),
    path('shop/bookings/deletebooking/', views.delete_booking),
    ...
    path('shop/create_booking/', views.booking),
    ...
    path('shop/bookings/<id_booking>/report/',
         views.report_user_form, name="report_user"),
    path('shop/chat/<id_chat>/report/',
         views.report_from_chat_form, name='report_chat'),
